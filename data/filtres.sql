...
insert into product (name, type_id, expired_date, price) values ('Мука', 3, '2022-06-07', 300);
insert into product (name, type_id, expired_date, price) values ('Хлеб', 3, '2022-06-07', 40);

select * from tipen where name = 'Сыр';
...
select t.name as Продукт, count(p.name) as Количество
