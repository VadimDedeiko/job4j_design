...
/*Далее рассмотрим, как создавать и использовать хранимые функции. Будем выполнять
  те же действия, что и ранее, добавляем записи в таблицу, а также редактировать
  существующие записи. На основе ранее использованных процедур хранимая функция
